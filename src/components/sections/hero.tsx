    ...
    <section className="px-4 sm:px-6 mb-8">
      <div className="py-16 md:py-24 max-w-[1200px] mx-auto flex flex-col items-center gap-6 lg:gap-8 md:flex-row">
        ...
        >
          {/* Main Headline */}
            <h1 
              className="font-medium tracking-tight text-[2.5rem] leading-[1.1] sm:text-[3rem] md:text-[3.5rem] lg:text-[4rem] text-foreground font-display"
            >
            ...
            <p 
              className="font-light text-muted-foreground text-lg md:text-[1.25rem] leading-[1.8] max-w-[700px] font-sans"
            >
